...
// The phrase catalog is one record per canonical key phrase (slug + category +
// English text); prettier expands each to a block, so it runs long without
// holding any logic.
const EXCLUDE_FILES = ['amplify/langgen/shared/phraseKeys.ts'];
