 ...
 *   assets/icon.png       — full-bleed light icon (speech bubbles on warm cream)
 *   assets/icon-dark.png  — full-bleed dark icon (glowing bubbles on charcoal)
 *
...
const BRAND_BG = { r: 0xfb, g: 0xf6, b: 0xf1 };
const DARK_BG = { r: 0x17, g: 0x12, b: 0x0f };
