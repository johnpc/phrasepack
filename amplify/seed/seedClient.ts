...
// (not the client's default identityPool) to be authorized.
...
/**
 * Delete every row of one model, paginating through ALL pages. Both list AND
 * delete use userPool: the seed runs as a signed-in editor, who can't read/
 * write via the identity-pool role.
 */
